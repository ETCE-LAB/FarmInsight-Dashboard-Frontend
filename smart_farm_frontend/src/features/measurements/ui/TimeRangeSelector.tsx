...
import {Calendar, DateInput, DateTimePicker} from "@mantine/dates";
...
export const TimeRangeSelector = ({onDateChange}: TimeRangeSelectorProps) => {
    ...
    const [customDate, setCustomDate] = useState<{ from: string; to: string } >(
        {from: '', to: ''}
    );
    ...
    return (
       <Container style={{marginBottom: '20px', marginLeft: '-1vw'}}>
           <SegmentedControl
               value={selectedRange}
