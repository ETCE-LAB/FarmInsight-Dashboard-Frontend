            ...
            de: {
                translation: {
                    ...
                    energy: {
                        ...
                        consumptionLiveMeasured: 'Dieser Wert wird live vom verknüpften Sensor gemessen.',
                        consumptionManualDescription: 'Geben Sie den erwarteten Stromverbrauch manuell ein.',
                        measuredBySensor: 'Gemessen durch Sensor',
                        outputLiveNote: 'Falls ein Sensor verknüpft ist, wird dieser Wert nur als Fallback verwendet.',
                        outputLiveMeasured: 'Dieser Wert wird live vom verknüpften Sensor gemessen.',
                        outputManualDescription: 'Geben Sie die aktuelle Leistungsabgabe manuell ein.',
                        batteryCapacitySource: 'Batteriekapazität (Wh)',
                        batteryCapacitySourceDescription: 'Maximale Energiekapazität der Batterie in Wattstunden (Wh).',
                        action: {
                        ...
                        forecastGraph: 'Energieprognose',
                        historicalConsumption: 'Historischer Verbrauch',
                        forecastConsumption: 'Prognostizierter Verbrauch',
                        forecastExpected: 'Erwartete Erzeugung',
                        forecastBestCase: 'Best Case',
                        forecastWorstCase: 'Worst Case',
                        generation: 'Erzeugung',
                        noForecastData: 'Keine Daten verfügbar',
                        noForecastDataHint: 'Es sind noch keine Energiedaten verfügbar. Fügen Sie Energieverbraucher und -quellen hinzu, um die Erfassung zu starten, oder konfigurieren Sie ein Energiemodell für Vorhersagen.',
                        noEnergyModel: 'Kein Energiemodell konfiguriert',
                        noEnergyModelHint: 'Um Vorhersagen zur Energieerzeugung zu sehen, fügen Sie in den FPF-Einstellungen unter Modelle ein Modell vom Typ "Energie" hinzu.',
                        forecastGraphInfo: 'Dieser Graph zeigt den historischen Verbrauch und die prognostizierte Energieerzeugung basierend auf Ihren konfigurierten Energiemodellen.',
                        liveFromSensor: 'Live',
